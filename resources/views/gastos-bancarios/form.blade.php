<div class="box box-info padding-1">
    <form id="gastoBancarioForm" method="POST" action="{{ route('GastosBancarios.store') }}">
        @csrf
        <div class="box-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const form = document.getElementById('gastoBancarioForm');
                ...
                form.addEventListener('submit', function(event) {
                    ...
                    fetch(form.action, {
                        ...
                        if (data.success) {
                            ...
                            window.location.href = "{{ route('GastosBancarios.index') }}";
                        } else {
