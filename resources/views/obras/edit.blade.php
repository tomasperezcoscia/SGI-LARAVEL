...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Editar Obra') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('obras.update', $obra->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="presupuesto_id" class="form-control" value="{{ $obra->presupuesto->id }}" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="insumos-table">
                                    ...
                                    <tbody>
                                        @foreach ($obra->insumos as $insumo)
                                            <tr>
                                                <td>{{ $insumo->nombre }}</td>
                                                <td><input type="number" name="cantidades[]" class="form-control" value="{{ $insumo->pivot->cantidad }}" min="0" required></td>
